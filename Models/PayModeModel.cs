...
namespace Supermarket_mvp.Models
{
    ...
    {
        [DisplayName("Pay Node Id")]

        public int Id { get; set; }

        [DisplayName("Pay Node Name")]
        ...
        [StringLength(200, MinimumLength = 3, ErrorMessage = "Pay mode observation must be between 8 and 200 characters")]
